...
class ValidateBinarySearchTreeTest {
    ...
    public void validateBinarySearchTree(){
        ...
        TreeNode rootNode = new TreeNode(2, oneNode, threeNode);
    ...
    public void validateBinarySearchTreeTwo(){
        ...
        TreeNode oneNode = new TreeNode(1);
        TreeNode threeNode = new TreeNode(3, fourNode, fifthNode);
        TreeNode rootNode = new TreeNode(2, oneNode, threeNode);
    ...
    @Test
    public void invalidateBinarySearchTreeThree(){
        TreeNode x = new TreeNode(3);
        TreeNode y = new TreeNode(6);
        TreeNode oneNode = new TreeNode(1);
        TreeNode threeNode = new TreeNode(4, x, y);
        TreeNode rootNode = new TreeNode(5, oneNode, threeNode);
